...
export default function Auth() {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      await authWithGoogle(selectedRole, isSignup ? "signup" : "signin");
    } catch (err) {
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-border rounded-xl py-3 hover:bg-muted transition-colors text-sm font-medium text-foreground disabled:opacity-60 disabled:cursor-not-allowed"
          >
            ...
            {googleLoading ? "Connecting to Google..." : isSignup ? "Sign Up with Google" : "Sign In with Google"}
          </button>
